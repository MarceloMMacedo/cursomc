...
//	private BCryptPasswordEncoder pe;
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Categoria cat3 = new Categoria(null, "ct3");
		Categoria cat4 = new Categoria(null, "ct4");
		Categoria cat5 = new Categoria(null, "ct5");
		Categoria cat6 = new Categoria(null, "ct6");
		Categoria cat7 = new Categoria(null, "ct7");
		Categoria cat8 = new Categoria(null, "c8");
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "marcelo_macedo01@hotmail.com", "36378912377", TipoCliente.PESSOAFISICA.getDescricao(),pe.encode("mmm"));
...
//		System.out.println(pe.encode("mmm"));
		...
		Pagamento pagto1 = new PagamentoComCartao(null, EstadoPagamento.QUITADO.getDescricao(), ped1, 6);
		ped1.setPagamento(pagto1);
		
		Pagamento pagto2 = new PagamentoComBoleto(null, EstadoPagamento.PENEDETE.getDescricao(), ped2, sdf.parse("20/10/2017 00:00"), null);
